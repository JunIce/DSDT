 ...
 *
 * Disassembly of SSDT8.aml, Mon Jan 15 12:25:27 2018
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00001B02 (6914)
 *     Revision         0x01
 *     Checksum         0x52
 *     OEM ID           "OptRef"
...
DefinitionBlock ("", "SSDT", 1, "OptRef", "OptTabl", 0x00001000)
{
    ...
    External (FREC, IntObj)
    External (GP12, IntObj)
    External (HLRS, FieldUnitObj)
    External (HTMF, FieldUnitObj)
        ...
        Method (GPS, 4, Serialized)
        {
            ...
            While (One)
            {
                ...
                ElseIf (LEqual (_T_0, 0x22))
                {
                    ...
                    If (LAnd (LAnd (LEqual (ACWT, One), LEqual (\FREC, One)), LEqual (\_SB.PCI0.LPCB.EC0.XCIN, One)))
                    {
                        If (LLess (PCAP, 0x08))
                        {
                            Store (0x08, PCAP)
                    ...
                    If (LAnd (LAnd (LEqual (HTMF, Zero), LEqual (ACWT, Zero)), LEqual (\_SB.PCI0.LPCB.EC0.XCIN, One)))
                    {
                        If (LLess (PCAP, One))
                        {
                            Store (One, PCAP)
