 ...
 *
 * Disassembly of SSDT6.aml, Mon Jan 15 12:25:27 2018
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x000031C0 (12736)
 *     Revision         0x01
 *     Checksum         0xBD
 *     OEM ID           "SaSsdt"
 *     OEM Table ID     "SaSsdt "
...
DefinitionBlock ("", "SSDT", 1, "SaSsdt", "SaSsdt ", 0x00003000)
{
    ...
    External (_SB_.PCI0.SBRG.EC0_.BRTS, UnknownObj)    // Warning: Unknown object
    External (_SB_.PEPD, UnknownObj)
    External (ADBG, MethodObj)    // 1 Arguments
    External (DSEN, FieldUnitObj)
    External (GP28, FieldUnitObj)
    ...
    OperationRegion (SANV, SystemMemory, 0xAD9D5E18, 0x016D)
        ...
        Device (GFX0)
        {
            ...
            Device (DD1F)
            {
                ...
                Method (_BCM, 1, NotSerialized)  // _BCM: Brightness Control Method
                {
                    ...
                    Else
                    {
                        Divide (Arg0, One, Local0, Local1)
                        Store (Local1, \_SB.PCI0.SBRG.EC0.BRTS)
                        Sleep (0x0A)
                    }
                }
